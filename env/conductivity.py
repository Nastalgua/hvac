...
def apply_conductivity(curr_temps: np.ndarray, thermal_conductivity: np.ndarray, scheduler):
    ...
    return np.pad(new_curr_temps + new_delta, 1, constant_values=[scheduler.curr_outside_temp])
